...
export function createNationKernelFixture(seed = 11): NationKernelState {
  ...
  return {
    ...
    networks: {}, budget: { treasury: 0, monthlyRevenue: 0, committedMonthlySpend: 0, taxRate: 0, administrationCapacity: 0, corruption: 0, stability: 48 }, designs: {}, productionLines: {}, stockpiles: {}, formations: {}, vessels: {}, fleets: {}, theatres: {}, spaceAssets: {}, spaceMissions: {},
    relations: { 'relation.player-peer': { id: 'relation.player-peer', actorAId: playerId, actorBId: peerId, stance: 'contact', trustAtoB: 0, trustBtoA: 0, agreementIds: [], grievanceIds: [] } }, agreements: {},
