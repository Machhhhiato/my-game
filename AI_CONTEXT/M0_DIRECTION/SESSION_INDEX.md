...
| `M0-S003` | `M0-DIR-A` | `mac` | 2026-08-21 11:55 +08:00 | active | `M0-S003-A191` | `sessions/20260821-1155-mac-m0-s003.md` |
...
补记：`M0-S003-AMEND-001` 只校正 `U078` 至 `R061` 的物理阅读顺序；完整消息仍在活动 session 原文件中，没有删除或改写。当前最后可见记录仍为 `M0-S003-A191`。文件：`sessions/20260825-1020-mac-m0-s003-amendment-001.md`。
