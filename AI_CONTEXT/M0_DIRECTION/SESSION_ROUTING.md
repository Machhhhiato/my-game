...
| `AG-M0｜L3-TEXT｜301｜MAC` | `01a03845-90a7-7c73-95e6-f48796358313` | `local` | `gpt-5.6-sol` / `medium` | `active` | 从 `context/m0-direction@c90d092` 创建；只读仓库，在最终消息交付 `TEXT-M0-001` |

当前活动下层任务为 `M0-L3-301` / `01a03845-90a7-7c73-95e6-f48796358313`。它从 `context/m0-direction@c90d092` 创建，使用 `gpt-5.6-sol` / `medium`，只读仓库并向第一层交付玩家文字包。
...
- `M0-L1-106`、`M0-L4-005`、`M0-L4-010`、`M0-L4-011`、`M0-L2-201` 已 accepted 且 `overall_spec_frozen: true`；当前 `M0-L3-301` active。
