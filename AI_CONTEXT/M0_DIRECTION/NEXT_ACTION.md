...
- 当前任务：`M0-L4-402`；执行单已冻结推送，第四层任务 `/root/m0_l4_402` 正在实现。
...
- 当前动作：收回 `/root/m0_l4_402` 的检查点和最终交付，第一层独立审查、退回、补修、测试和 Git 收口；不得进入 `M0-L4-403`。
...
任务状态：M0-L4-401-R1 accepted｜M0-L4-402 active
...
第四层任务：/root/m0_l4_402｜gpt-5.6-terra / medium
