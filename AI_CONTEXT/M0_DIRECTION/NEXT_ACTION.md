...
- 当前动作：第一项已部分确认；星球必须是真球体，其余六边格规则被接受。当前确认南北极永久封口、底层隐藏闭合格、可用地表纯六边格；第二项暂停。
...
4. 用户在 `M0-S003-U018` 重新打开第一项，在 `U019` 接受除两处修正外的方案，并在 `U020` 提出用南北极不可用冰盖隐藏球面闭合结构；当前确认该永久边界，第二项暂停。
