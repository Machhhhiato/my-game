...
- 当前动作：第六项已经按 `5:4:1` accepted，并补充旧时代科技考古、先驱文明研究与来源归责规则；权威源包升为 revision 5。下一步开始第七项，只讨论不同内容的长度与重复内容缩写。
...
源包：revision 5｜追加A171提案与U070修订｜保留revision 4全部校准和既有15+13语料
已撤回：轻度目标｜严肃30/轻度20/中度35/重度15｜两次战斗神经抑制示意作为质量标杆
当前项：第七项｜不同内容多长、重复内容怎样缩短｜active
下一步：提出科技正文、首次工程、阶段记录、通知和重复日志的长度分工
```

## 完成条件

`M0-L1-105` 已在 `ab02d36` accepted，`M0-L1-106` 已 active。第一项至第六项 accepted，视觉仍待整体 UI 重做；第七项 active，第八项 pending。revision 5 全文源包门禁立即约束未来第二、第三层。第七至第八项逐项接受并最终整体接受后，才可标记 `overall_spec_frozen`。
