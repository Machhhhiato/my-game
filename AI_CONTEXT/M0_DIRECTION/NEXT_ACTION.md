...
- 当前动作：第四项已经接受；下一轮开始第五项“制度性荒诞怎样写、反转怎样去重”。本轮不提前提交第五项方案。
...
当前项：第五项｜制度性荒诞怎样写、反转怎样去重｜active
...
下一步：下一轮开始第五项；本轮不提前提交方案
```

## 完成条件

`M0-L1-105` 已在 `ab02d36` accepted，`M0-L1-106` 已 active。第一项信息结构、第二项两行正文、第三项二态展示和第四项最小通知分工 accepted，视觉仍待整体 UI 重做；第五项 active。全文源包门禁立即约束未来第二、第三层。第五至第八项逐项接受并最终整体接受后，才可标记 `overall_spec_frozen`。
