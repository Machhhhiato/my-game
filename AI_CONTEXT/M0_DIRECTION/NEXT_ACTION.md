...
- 当前动作：第三项已经 accepted；下一轮开始第四项，讨论科研、建设、事故、验收和维护分别使用什么载体、什么时候主动提示。本轮不提前提出第四项方案。
...
当前项：第四项｜不同内容使用什么载体、什么时候主动提示｜active
...
`M0-L1-105` 已在 `ab02d36` accepted，`M0-L1-106` 已 active。第一项信息结构、第二项两行正文和第三项二态展示 accepted，视觉仍待整体 UI 重做；第四项 active。全文源包门禁立即约束未来第二、第三层。第四至第八项逐项接受并最终整体接受后，才可标记 `overall_spec_frozen`。
