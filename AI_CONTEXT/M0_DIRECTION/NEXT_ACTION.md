...
- 当前动作：等待用户复核第六项提案：强度按真实后果分级，全库目标为严肃 30%、轻度 20%、中度 35%、重度 15%，关键科技与高级资产优先保护成就感。
...
当前项：第六项｜严肃、轻度、中度、重度怎样分配｜active_review
...
当前提案：真实后果分级｜严肃30｜轻度20｜中度35｜重度15｜关键资产保护爽感
下一步：用户接受或修正第六项；接受后再进入第七项
```

## 完成条件

`M0-L1-105` 已在 `ab02d36` accepted，`M0-L1-106` 已 active。第一项至第五项 accepted，视觉仍待整体 UI 重做；第五项新增轻度示例的力度明确未接受，第六项 active_review。新版全文源包门禁立即约束未来第二、第三层。第六至第八项逐项接受并最终整体接受后，才可标记 `overall_spec_frozen`。
