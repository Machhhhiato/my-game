...
- 当前讨论：第四项 active；货物批次、位置库存、中断绕行和独立管线逻辑已经获得用户正面认可，当前按 `M0-S003-U024` 修订运输升级归属。
- 第四项修订提案：车队保存车队人力、运输资产、载量与基础速度；路线连接保存路面、路基、桥涵和损坏；来源与目的地设施分别保存装卸能力、当地人员和已部署工业载具。卡车、叉车或道路科技都必须经过真实生产、部署、能源/维护或工程建设才生效。
