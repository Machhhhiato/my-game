...
handoff_id: M0-H002
updated_at: 2026-08-21T23:25:29+08:00
---
...
- 启动来源：`M0-S003-U027`。
- 第一项：active；同一条真实科研工作线有两种选题方式：玩家指定远期目标或手动排队，以及领域按严格顺序自动轮转。自动轮次先让第一领域进入共同下一阶段，再让其余领域追平，随后按相同顺序补普通科技。
- 第二项：pending；精密制造中心与勘测无人机的实体链。
- 第三项：pending；第一座前哨完整首建、稳定验收与标准工程包。
- 第四项：pending；第二座自动复制、暂停、恢复和人工接管。
- 下一步：用户接受或修订 `M0-S003-U028` 后的第一项科研控制提案。
