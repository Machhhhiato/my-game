...
`SPEC-M0-INTEGRATED-001` 与 `M0-L1-105` 已在 `ab02d36` accepted。`M0-L1-106` 第一项至第七项已 accepted；第八项 active，其中 `D-M0-DIR-012` 至 `D-M0-DIR-016` 已确认第一层统筹、Mac 单机、模型默认、冻结后能力审计、单张内部工作单和缺失退回规则。`M0-S003-A195` 已提出第三部分逐条确认与抽查范围，当前为 `proposal_active_review`；统计口径与最终冻结仍待确认。第二、三、四层继续按依赖阻塞；本轮没有创建下层任务。
...
- 当前问题：`Q-M0-032` 为 `active_in_M0-L1-106`；第一项至第七项和第八项第一、第二部分 accepted；第八项第三部分与 `Q-M0-042` active_review。不能冒充第八项整体 accepted。
...
- 路由决定：`D-M0-DIR-007`、`D-M0-DIR-009` 至 `D-M0-DIR-016`、`D-M0-PROD-036` 至 `D-M0-PROD-046`。
