...
`M0-L1-102 · 人力、资源、库存底线与压力`：位于 Mac 的 `M0-DIR-A` / `M0-L1-DIRECTION` / `M0-S003`，当前状态为 `active`。前两项已接受；当前复核第三项两层库存底线、四级优先级、预警、自动暂停与恢复。
