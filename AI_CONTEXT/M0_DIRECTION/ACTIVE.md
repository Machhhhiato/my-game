...
`M0-L1-102 · 人力、资源、库存底线与压力`：位于 Mac 的 `M0-DIR-A` / `M0-L1-DIRECTION` / `M0-S003`，当前状态为 `active`。前三项已接受；当前复核第四项连续三日取水受阻、两条正常路线与临时数字演算。
